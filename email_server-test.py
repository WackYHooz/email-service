...
#     读取常见的正文与签名分界处格式
    try:
        sig_format = [line.strip() for line in open("email_server_signature-test.ini",encoding='gb18030',errors='ignore').readlines()]
    except Exception as e:
...
#     加载预设变量
    ...
    ini_param_tmp = [line.strip() for line in open("email_server-test.ini",encoding='gb18030',errors='ignore').readlines()]
    ini_param = []
